const InputJoin = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      <span className="font-medium text-base text-white whitespace-nowrap absolute left-5 top-1 -translate-y-1/2 peer-focus:text-slate-400 peer-focus:-translate-y-4 peer-focus:text-xs peer-focus:transition-all duration-300 ease-in-out sm:top-6">
        {children}
      </span>
