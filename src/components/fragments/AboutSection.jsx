        ...
        >
          {selectMovie && (
            <div key={selectMovie.id}>
              ...
              <div
                className="relative w-full h-56 px-5 py-3 flex flex-col justify-end bg-cover backdrop-bg"
                style={{
              ...
              <div className="w-full px-5 py-4 bg-zinc-700">
                <SmallDescription className="font-light text-white text-sm mb-3 lg:text-base xl:text-lg">
